...
class Produto extends Component {
    ...
    adicionar(){
        ...
        render() {
            ...
            <PageForm>
                <div>
                    Nome: <input className="quadro"
                        ref={this.nome} 
                        type="text" 
                        value={this.props.nome} 
                        onChange={this.atualiza} /><br/>
                    Preço: <input className="quadro"
                        ref={this.preco} 
                        type="text" 
                        value={this.props.preco} 
                        onChange={this.atualiza}/><br/>
                    Quantidade: <input className="quadro"
                        ref={this.quantidade} 
                        type="text"
                        value={this.props.quantidade} 
                        onChange={this.atualiza}/>
                        <br/>
                    <input className="botao" type="button" value="Adicionar" onClick={this.adicionar}/>
                </div>
            </PageForm>
        );
    }
